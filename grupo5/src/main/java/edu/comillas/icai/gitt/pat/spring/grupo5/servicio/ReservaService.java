...
public class ReservaService {
    ...
    public Reserva reprogramarReserva(Long reservationId, Reserva reservaNueva, Usuario usuarioAutenticado) {
        ...
        // Validar que la pista existe (en caso de cambio de pista)
        if (reservaNueva.pista != null) {
            Long nuevaPistaId = reservaNueva.pista.idPista();
            validarPistaExiste(nuevaPistaId);
    ...
    /**
     * Valida que la pista existe
     */
    private void validarPistaExiste(Long pistaId) {
        Pista pista = pistaService.lee(pistaId);
        if (pista == null) {
