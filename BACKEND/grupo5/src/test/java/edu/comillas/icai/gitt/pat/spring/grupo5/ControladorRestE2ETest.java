...
class ControladorRestE2ETest {
    ...
    @Test
    void crearDisponibilidad_ok_201() {
        HttpHeaders headers = new HttpHeaders();
        //headers.setBasicAuth("admin", "clave");

        Pista pista = new Pista(null, "Pista E2E Disp", "Madrid", 10, true, "2026-01-01");
        ...
        Long pistaId = pistaResp.getBody().id;
    ...
    @Test
    void getDisponibilidadGeneral_ok_200() {
        HttpHeaders headers = new HttpHeaders();
        //headers.setBasicAuth("admin", "clave");

        Pista pista = new Pista(null, "Pista E2E Disp2", "Madrid", 10, true, "2026-01-01");
        ResponseEntity<Pista> pistaResp = restTemplate.exchange(
                "/pistaPadel/courts",
                HttpMethod.POST,
                new HttpEntity<>(pista, headers),
    ...
    """.formatted(pistaId);
        ...
        restTemplate.exchange("/pistaPadel/availability", HttpMethod.POST,
                new HttpEntity<>(body, jsonHeaders), String.class);

        ResponseEntity<String> response = restTemplate.exchange(
                "/pistaPadel/availability?date=2026-06-02",
                HttpMethod.GET,
                null,
                String.class
        );
        ...
        Assertions.assertEquals(HttpStatus.OK, response.getStatusCode());
        Assertions.assertTrue(response.getBody().contains("2026-06-02"));
    }

    @Test
    void getDisponibilidadPorPista_ok_200() {
        HttpHeaders headers = new HttpHeaders();
        //headers.setBasicAuth("admin", "clave");

        Pista pista = new Pista(null, "Pista E2E Disp3", "Madrid", 10, true, "2026-01-01");
        ResponseEntity<Pista> pistaResp = restTemplate.exchange(
                "/pistaPadel/courts",
                HttpMethod.POST,
                new HttpEntity<>(pista, headers),
    ...
    """.formatted(pistaId);
        ...
        ResponseEntity<String> response = restTemplate.exchange(
                "/pistaPadel/courts/" + pistaId + "/availability?date=2026-06-03",
                HttpMethod.GET,
                null,
                String.class
        );
    ...
    @Test
    void getDisponibilidadPorPista_noExiste_404() {
        ResponseEntity<String> response = restTemplate.exchange(
                "/pistaPadel/courts/99999/availability?date=2026-06-04",
                HttpMethod.GET,
                null,
                String.class
        );
