...
public class ControladorREST {
    ...
    public List<Reserva> obtenerMisReservas(@RequestHeader(name = "Authorization", required = false) String authHeader) {

        // Obtener usuario autenticado
        Usuario usuarioAutenticado = usuarioService.getAuthenticatedUser(authHeader);

        // Delegar a ReservaService (que valida que es ADMIN)
        return reservaService.obtenerMisReservas(usuarioAutenticado);
    }
    ...
    // ============================
        ...
        @GetMapping("/pistaPadel/availablereservations")
    ...
    @PostMapping("/pistaPadel/availability")
    @ResponseStatus(HttpStatus.CREATED)
